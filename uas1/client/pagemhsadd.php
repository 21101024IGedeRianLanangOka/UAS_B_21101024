...
<h3 class="text-center judul">Tambah Data Mahasiswa</h3>
...
<form>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="txnama" placeholder="Isi Nama Mahasiswa">
    </div>
    <div class="mb-3">
        <label class="form-label">Tgl Lahir</label>
        <input type="date" class="form-control" id="txtglahir" placeholder="Isi Tgl Lahir">
    </div>
    <div class="mb-3">
